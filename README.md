# 🌐 Java Bootstrap Dynamic Web Project

A dynamic web application built using **Eclipse Dynamic Web Project**, **Bootstrap template**, **HTML**, **JavaScript**, and **REST API integration**.  
The project is deployed on **Apache Tomcat** and demonstrates login, API data fetching, and responsive UI using Bootstrap.

---

## 🚀 Features
- Dynamic Web Project (Eclipse)
- Bootstrap 5 Responsive Template
...
<script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>    <!-- add cdn -->
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <script >
         function api(){
        	 let nm=localStorage.getItem("name");            //data lao
        	 let id=localStorage.getItem("id");
        	 alert(nm);
        	 alert(nm);
        	 console.log(id);
        	 document.getElementById("nm").innerHTML=nm;    //data set
        	// alert("JAVA API TEST");
        
        	 axios.get("https://api.rootnet.in/covid19-in/stats/latest")        //api call
        	 .then(responce=>{
        		console.log(responce.data); 
        		document.getElementById("a").innerHTML=responce.data.data.summary.confirmedCasesIndian;
        		document.getElementById("b").innerHTML=responce.data.data.summary.confirmedCasesForeign;
        		document.getElementById("c").innerHTML=responce.data.data.summary.discharged;
        		document.getElementById("d").innerHTML=responce.data.data.summary.deaths;
        	 })
         }
...
<body onload="api()" class="index-page">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container text-center" data-aos="fade-up" data-aos-delay="100">
        <img src="assets/img/logo.png" class="img-fluid mb-3" alt="">
         <h2 id="nm"></h2>
        <h2>Welcome to Kurre Computers</h2>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/kurre.jpg" class="img-fluid" alt="">
          </div>
...
## 👨‍💻 Author
Kumlesh Kurre
Java | Web Development | Bootstrap | API Integration
